<template>
  <div>
    ...
    <el-form :model="addRoleForm"  :rules="roleFormRules" ref="addRoleFormRef" labl-width="80px">
    ...
    <span slot = 'footer' class="dialog-footer">
        <el-button @click="addDialogVisible=false">取 消</el-button>7
        ...
        return {
            ...
            roleFormRules:{
                roleName:[
                    ...
                    {min:2,max:10,message:'长度需要2到10之间',trigger:'blur'}
                ],
                roleDesc:[
                    {required:true,message:'请输入角色名称',trigger:'blur'},
                    {min: 3, max: 20,meessage:'长度需要在3到20之间',trigger:'blur'}
                ]
            }
        }
    },
