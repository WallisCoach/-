<template>
  <div>
    ...
    <el-card>
        <el-row :gutter="20">
            <el-col :span="8">
                <en-input placeholder="请输入内容" v-model="queryInfo.query" clearable @clear="getGoodsList">
                    <el-button slot="append" icon="el-icon-seach" @click="getGoodList">
                    </el-button>
                </en-input>
            </el-col >
            <el-col :span='4'>
                <el-button type="primary" @click="goAdddPage">添加商品</el-button>
            </el-col>
        </el-row >
        ...
        <el-table :data="goodList" border stripe>
            ...
            <el-table-column label="操作" width="200px">
                <template slot-scope="scope">
                    ...
                    <el-button type="danger" icon="el-icon-delete" size="mini" @click="remoceGoods(scope.row.goods_id)">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
    </el-card>
...
import BreadcrumbNavVue from '../common/BreadcrumbNav.vue';
import{
    getGoodsListRequest,
